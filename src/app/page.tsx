  ...
  return (
    <main className="grid min-h-screen grid-cols-2">
      ...
      <div className="relative flex flex-col items-start justify-between overflow-hidden border-r border-white/10 bg-[url(../assets/bg-stars.svg)] px-28 py-16">
        ...
        <a
          href="#"
          className="text- flex items-center gap-3 transition-colors hover:text-gray-50"
        >
        ...
        <div className="space-y-5">
          ...
          <a
            href="#"
            className="inline-block rounded-full bg-green-500 px-5 py-3 font-alt text-sm uppercase leading-none text-black hover:bg-grey-600"
          >
            Cadastrar Lembrança
          </a>
        </div>
